      ...
      <div className="max-w-5xl mx-auto">
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-center px-4 py-12">
            ...
            <h3 className="welcome-heading mb-1">Welcome to <span className='welcome-heading-gradient gradient-animation'>Capex Forecasting</span></h3>
            <p className="welcome-text max-w-sm">
              Ask me anything related to the files
            </p>
          </div>
        ) : (
          <>
