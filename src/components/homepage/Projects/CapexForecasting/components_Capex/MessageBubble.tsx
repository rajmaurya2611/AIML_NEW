...
const markdownComponents = {
  ...
  code: ({ inline, className, children, ...props }: any) => (
    <code
      className={`${
        inline ? "bg-gray-100 px-1 rounded text-red-600" : "block bg-gray-900 text-white p-2 rounded-lg"
      } ${className || ""}`}
      {...props}
    >
      {children}
